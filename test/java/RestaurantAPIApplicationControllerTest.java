...
public class RestaurantAPIApplicationControllerTest {
    ...
    @Test
    public void getTopRestaurantsBasedOnRatingByCuisine() throws MalformedJsonException {
        ...
        getTopRestaurantsBasedOnRatingByCuisineRequest.setRating("3");
        ...
        String rating = getTopRestaurantsBasedOnRatingByCuisineRequest.getRating();
    ...
    public void getTopRestaurantsBasedOnRatingByCuisineValidationExceptionWithCuisineAndRating() throws Exception {
        ...
        String expected = "{\"rating\":\"must be less than or equal to 5\",\"cuisine\":\"Make sure the cuisine is lower case\"}";
    ...
    public void getTopRestaurantsBasedOnRatingByCuisineValidationExceptionNullParams() throws Exception {
        ...
        String expected = "{\"rating\":\"rating should not be null\",\"cuisine\":\"cuisine name should not be null\"}";
    ...
    public void getTopRestaurantsBasedOnRatingByCuisineValidationExceptionMaxNum() throws Exception {
        ...
        String expected = "{\"maxNum\":\"please request only digits between 0 and 999\"}";
